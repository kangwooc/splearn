...
import static tobyspring.splearn.splearn.AssertThatUtils.equalsTrue;
import static tobyspring.splearn.splearn.AssertThatUtils.notNull;
...
public class MemberApiTest {
    ...
    void register() throws JsonProcessingException, UnsupportedEncodingException {
        ...
        assertThat(result).hasStatusOk()
                ...
                .hasPathSatisfying("$.email", equalsTrue(request));
